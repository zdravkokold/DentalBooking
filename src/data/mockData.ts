...
export const dentists: Dentist[] = [
  {
    ...
    specialization: 'Общ дентист',
    imageUrl: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3',
    bio: 'Д-р Иван Петров е висококвалифициран общ дентист с над 10 години опит. Той се специализира в профилактична грижа и лечение на кариеси, осигурявайки комфортна и спокойна среда за своите пациенти.',
    rating: 4.8,
  ...
  },
  {
    ...
    bio: 'Д-р Мария Димитрова е специалист ортодонт с експертиза в лечение с брекети и алайнери. С нейния внимателен подход, тя помага на пациентите да постигнат красива и здрава усмивка.',
    rating: 4.9,
    yearsOfExperience: 8,
